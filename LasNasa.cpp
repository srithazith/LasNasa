...
void module1() // AMPLIFICATION
{
setbkcolor(YELLOW);
setcolor(BLUE);
settextstyle(7,HORIZ_DIR,4);
outtextxy(50,180,"Welcome to Laser Demo in C");
delay(3000);
...
setcolor(YELLOW);
settextstyle(7,HORIZ_DIR,4);
outtextxy(120,80,"Thankyou For watching");
outtextxy(120,180,"bestengineeringprojects.com");
